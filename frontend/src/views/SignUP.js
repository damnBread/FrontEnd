...
function SignUP() {
  ...
  const onClickSignUP = async () => {
    ...
    const workAreaArray = Array.isArray(InputWorkArea)
      ? InputWorkArea
      : [InputWorkArea];
    const workJobArray = Array.isArray(InputWorkJob)
      ? InputWorkJob
      : [InputWorkJob];
