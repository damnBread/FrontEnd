...
const Damnrank1 = () => {
  ...
  const [selectedHourPay, setSelectedHourPay] = useState([]); //시급
  const [InputHourPay, setInputHourPay] = useState(null);
  ...
  const DonghandleClickWorkArea = (dongItem) => {
    ...
    const addWorkArea =
      SelectWorkArea + " " + citySelectWorkArea + " " + dongItem;
  ...
  const removeWorkArea = (workAreaToRemove) => {
    //지역 하나씩 삭제
  ...
  const removeWorkJob = (workJobToRemove) => {
    //업직종 하나씩 삭제
  ...
  const updateInputWorkJob = (removedJob) => {
    setInputWorkJob(
      SelectWorkJob.filter((job) => job !== removedJob).join("|")
    );
  };
  ...
  const removeGender = (genderToRemove) => {
    const updatedGenders = selectedGenders.filter(
  ...
  const removeCareer = (CareerToRemove) => {
    //경력 하나씩 삭제
  ...
  //세부조건 -> 시급
  const handleInputHourPay = (event) => {
    const value = event.target.value;
    setInputHourPay(value);
  };

  const handleHourPayClick = () => {
    if (InputHourPay !== "" && !selectedHourPay.includes(InputHourPay)) {
      const HourPayInt = parseInt(InputHourPay, 10);
      if (!isNaN(InputHourPay)) {
        setSelectedHourPay([...selectedHourPay, InputHourPay]);
      }
    }
  };

  const removeHourPay = (HourPayToRemove) => {
    //시급 하나씩 삭제
    setSelectedHourPay((prevHourPays) => {
      prevHourPays.filter((hourpay) => hourpay !== HourPayToRemove);
    });
  };
  ...
  function onClickFilter() {
    ...
    const hourpayparsedInt = parseInt(InputHourPay);
    console.log("4556", hourpayparsedInt);
    console.log("5555: ", typeof InputCareer);
    const carrerInt = parseInt(InputCareer);
    const page = 1;

    axios
      .post("http://localhost:3000/damnlist/filter/" + page, {
        //연동 완료 ~~
        location: InputWorkArea,
        job: InputWorkJob,
        gender: selectedGenders,
        age: ageparsedInt,
        hourpay: hourpayparsedInt,
      })
      .then((res) => {
  ...
  return (
    <div>
          ...
          <div>
            ...
            >
              ...
              <img
                ...
                style={{
                  marginLeft: "30px",
                  transform: `rotate(${imageRotationArea}deg)`,
                }}
              />
            </button>
            ...
            >
              ...
              <img
                ...
                style={{
                  marginLeft: "30px",
                  transform: `rotate(${imageRotationJob}deg)`,
                }}
              />
            </button>
            ...
            >
              ...
              <img
                ...
                style={{
                  marginLeft: "30px",
                  transform: `rotate(${imageRotationCondi}deg)`,
                }}
              />
            </button>
          ...
          <div className="items-container-rank scrollable-container-rank">
            {items.map((item, index) => (
              <div
                ...
                className={`custom-modal-box-rank ${
                  SelectWorkArea === item.type ? "select-rank" : ""
                }`}
              >
                {item.title}
              </div>
              ...
              {items_city
                ...
                .map((cityItem, index) => (
                  <div
                    ...
                    className={`custom-modal-box-rank ${
                      citySelectWorkArea === cityItem.title ? "select-rank" : ""
                    }`}
                  >
                    {cityItem.title}
                  </div>
              ...
              {items_dong
                ...
                .map((dongItem, index) => (
                  <div
                    ...
                    className={`custom-modal-box1-rank ${
                      dongSelectWorkArea === dongItem.title ? "select-rank" : ""
                    }`}
                  >
                    {dongItem.title}
                  </div>
      ...
      {showJob && (
        <div className="custom-modal-content-rank1">
          <div className="work-icon1">
            <div
              className={`icon-style ${
                SelectWorkJob.includes("카페") ? "active" : ""
              }`}
              style={{ position: "relative", left: "40px", top: "20px" }}
            >
              <button
                className="icon-style"
                onClick={() => handleWorkJobClick("카페")}
              >
                <img src={workbackground} width="105" alt="cafeImage1" />
                <span
                  style={{ position: "absolute", top: "32px", left: "40px" }}
                >
                  <img
                    src={workcoffeebeans}
                    id="카페"
            ...
            <span
              className="jobicon-margin"
              style={{ position: "absolute", top: "320px", left: "577px" }}
            >
              <b>카페</b>
            </span>
            ...
            <span>
              <div
                className={`icon-style ${
                  SelectWorkJob.includes("서빙") ? "active" : ""
                }`}
                style={{ position: "relative", left: "120px", top: "20px" }}
              >
                <button
                  className="icon-style"
                  onClick={() => handleWorkJobClick("서빙")}
                >
                  <img src={workbackground} width="105" alt="platterImage1" />
                  <span
                    style={{ position: "absolute", top: "37px", left: "40px" }}
                  >
                    <img
                      src={workplatter}
                      id="서빙"
              ...
              <span
                className="jobicon-margin"
                style={{ position: "absolute", top: "320px", left: "777px" }}
              >
                <b>서빙</b>
              </span>
            </span>
            ...
            <span>
              <div
                className={`icon-style ${
                  SelectWorkJob.includes("판매") ? "active" : ""
                }`}
                style={{ position: "relative", left: "200px", top: "20px" }}
              >
                <button
                  className="icon-style"
                  onClick={() => handleWorkJobClick("판매")}
                >
              ...
              <span
                className="jobicon-margin"
                style={{ position: "absolute", top: "320px", left: "974px" }}
              >
                <b>판매</b>
              </span>
            </span>
            ...
            <span>
              <div
                className={`icon-style ${
                  SelectWorkJob.includes("주방 보조") ? "active" : ""
                }`}
                style={{ position: "relative", left: "280px", top: "20px" }}
              >
                <button
                  className="icon-style"
                  onClick={() => handleWorkJobClick("주방 보조")}
                >
              ...
              <span
                className="jobicon-margin"
                style={{ position: "absolute", top: "320px", left: "1150px" }}
              >
                <b>주방 보조</b>
              </span>
            </span>
            ...
            <div>
              <div
                className={`icon-style ${
                  SelectWorkJob.includes("배달") ? "active" : ""
                }`}
                style={{ position: "relative", left: "360px", top: "20px" }}
              >
                <button
                  className="icon-style"
                  onClick={() => handleWorkJobClick("배달")}
                >
              ...
              <span
                className="jobicon-margin"
                style={{ position: "absolute", top: "320px", left: "1370px" }}
              >
                <b>배달</b>
              </span>
            </div>
          ...
          <div className="work-icon">
            <div
              className={`icon-style ${
                SelectWorkJob.includes("교육") ? "active" : ""
              }`}
              style={{ position: "relative", left: "40px", top: "70px" }}
            >
              <button
                className="icon-style"
                onClick={() => handleWorkJobClick("교육")}
              >
                <img src={workbackground} width="105" alt="educationImage1" />
                <span
                  style={{ position: "absolute", top: "35px", left: "38px" }}
                >
                  <img
                    src={workeducation}
                    id="교육"
            ...
            <span
              className="jobicon-margin"
              style={{ position: "absolute", top: "478px", left: "577px" }}
            >
              <b>교육</b>
            </span>
            ...
            <div
              className={`icon-style ${
                SelectWorkJob.includes("스태프") ? "active" : ""
              }`}
              style={{ position: "relative", left: "120px", top: "70px" }}
            >
              <button
                className="icon-style"
                onClick={() => handleWorkJobClick("스태프")}
              >
            ...
            <span
              className="jobicon-margin"
              style={{ position: "absolute", top: "478px", left: "770px" }}
            >
              <b>스태프</b>
            </span>
            ...
            <div
              className={`icon-style ${
                SelectWorkJob.includes("생산") ? "active" : ""
              }`}
              style={{ position: "relative", left: "200px", top: "70px" }}
            >
              <button
                className="icon-style"
                onClick={() => handleWorkJobClick("생산")}
              >
            ...
            <span
              className="jobicon-margin"
              style={{ position: "absolute", top: "478px", left: "974px" }}
            >
              <b>생산</b>
            </span>
            ...
            <div
              className={`icon-style ${
                SelectWorkJob.includes("미디어") ? "active" : ""
              }`}
              style={{ position: "relative", left: "280px", top: "70px" }}
            >
              <button
                className="icon-style"
                onClick={() => handleWorkJobClick("미디어")}
              >
            ...
            <span
              className="jobicon-margin"
              style={{ position: "absolute", top: "478px", left: "1165px" }}
            >
              <b>미디어</b>
            </span>
            ...
            <div
              className={`icon-style ${
                SelectWorkJob.includes("고객 상담") ? "active" : ""
              }`}
              style={{ position: "relative", left: "370px", top: "70px" }}
            >
              <button
                className="icon-style"
                onClick={() => handleWorkJobClick("고객 상담")}
              >
            ...
            <span
              className="jobicon-margin"
              style={{ position: "absolute", top: "478px", left: "1350px" }}
            >
              <b>고객 상담</b>
            </span>
          </div>
      ...
      {showConditions && (
        <div className="custom-modal-content-rank1">
          <div>
            <label className="label-style" style={{ zIndex: 1 }}>
              <b>성별</b>
            </label>

            <button
              type="button"
              className={`gender-style1 ${
                arraysAreEqual(selectedGenders, [1, 0])
                  ? "gender-select-style"
                  : ""
              }`}
            ...
            <button
              ...
              className={`gender-style ${
                arraysAreEqual(selectedGenders, [0, 1])
                  ? "gender-select-style"
                  : ""
              }`}
            ...
            <button
              type="button"
              className={`gender-style ${
                arraysAreEqual(selectedGenders, [1, 1])
                  ? "gender-select-style"
                  : ""
              }`}
          ...
          <div>
            <label className="label-style1" style={{ zIndex: 1 }}>
              <b>연령</b>
            </label>
            <label className="label-style2 inputAge-label-style">
              만
              <input
                type="text"
                className="inputAge-style"
                id="age"
                name="age"
                placeholder="0"
                value={InputAge}
              ...
              />
              <label
                className="inputAge-label-style"
          ...
          <div>
            <label className="label-style1" style={{ zIndex: 1 }}>
              ...
              <button
                type="button"
                onClick={handleHourPayClick}
                className="inputAge-btn-style"
                disabled={!InputHourPay}
              >
                확인
              </button>
            </label>
        ...
        >
          {
            <span className="left-align-footer-rank">
              {addedWorkAreas.map((workArea, index) => (
                <div
                  key={index}
                  className={`addedWorkArea-style-rank ${
                    shouldApplyActiveStyle(workArea) ? "active" : ""
                  }`}
                >
                  {workArea}
                  <button
              ...
              {SelectWorkJob.map((workJob, index) => (
                <div
                  key={index}
                  className={`addedWorkArea-style-rank ${
                    shouldApplyActiveStyle(workJob) ? "active" : ""
                  }`}
                >
                  {workJob}
                  <button
              ...
              {selectedGenders.map((gender, index) => (
                <span
                  key={index}
                  className={`addedWorkArea-style-rank ${
                    shouldApplyActiveStyle(gender) ? "active" : ""
                  }`}
                >
                  {getGenderLabel()}
                  <button
              ...
              {selectedAges.map((age, index) => (
                <span
                  key={index}
                  className={`addedWorkArea-style-rank ${
                    shouldApplyActiveStyle(age) ? "active" : ""
                  }`}
                >
                  {age}세
                  <button className="close-rank" onClick={() => removeAge(age)}>
                    x
                  </button>
                </span>
              ))}
              ...
              {selectedHourPay &&
                selectedHourPay.length > 0 &&
                selectedHourPay.map((hourpay, index) => (
                  <span
                    key={index}
                    className={`addedWorkArea-style-rank ${
                      shouldApplyActiveStyle(hourpay) ? "active" : ""
                    }`}
                  >
                    {hourpay}원
                    <button
                      className="close-rank"
                      onClick={() => removeHourPay(hourpay)}
                    >
                      x
                    </button>
                  </span>
              ...
              {selectedCareers.map((career, index) => (
                <span
                  key={index}
                  className={`addedWorkArea-style-rank ${
                    shouldApplyActiveStyle(career) ? "active" : ""
                  }`}
                >
                  {career}개월 이상
                  <button
