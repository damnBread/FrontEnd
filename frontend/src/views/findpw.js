...
function Findid() {
    ...
    function emailVerify() {
        ...
        .then(async response => {
            ...
            console.log("pw 찾기 email get 완료!")
    ...
    function findpw() {
        axios.post('http://localhost:3000/login/findPw', {
            email: InputEmail,
            pw: InputPW
        })
        .then(async response => {
            console.log(response);
            console.log("pw 찾기 완료!");
            setStatus(true);
        })
        .catch((error) => {
            console.log(error);
    ...
    return(
        <div>
            ...
            {!status ? (
                        ...
                        <div>
                            <input type='text' id="id" name="id" placeholder="인증 코드" value={InputCode}
                                 onChange={handleInputCode} style={{width:"450px", height: "40px", marginTop: "15px", 
                                  borderColor: "#E7E6E6", fontSize: "15px", borderRadius: "10px", padding: ".5em"}} />
                            <button type='button' onClick={findpw} disabled={InputCode.length !==0 ? false:true } style={{fontSize: "11px", width: "90px", height: "30px", 
                            borderColor: "#BF5E49", marginLeft: "10px", marginTop: "10px", backgroundColor: "#BF5E49B0",
                ...
                <div className="login-form">
                <label style={{fontSize: "16px", marginTop: "-300px", marginLeft: "-490px", zIndex: 1}}><b>비밀번호를 다시 설정해주세요.</b></label>
                        <div>
                        <input type='password' id="pw" name="pw" placeholder="비밀번호" value={InputPW}
                                 onChange={handleInputPW} style={{width:"450px", height: "40px", marginTop: "15px", 
                                  borderColor: "#E7E6E6", fontSize: "15px", borderRadius: "10px", padding: ".5em"}} />
                        </div>
                        <div>
                        <input type='password' id="pw" name="pw" placeholder="비밀번호 확인" value={InputPWCHK}
                                 onChange={handleInputPWCHK} style={{width:"450px", height: "40px", marginTop: "15px", 
                                  borderColor: "#E7E6E6", fontSize: "15px", borderRadius: "10px", padding: ".5em"}} />
                        </div>
                        <button type='button' style={{fontSize: "11px", width: "150px", height: "30px", 
                        borderColor: "#BF5E49", marginLeft: "10px", marginTop: "10px", backgroundColor: "#BF5E49B0",
                         border:"0px", borderRadius: "5px"}}>아이디 찾기</button>
                         <button type='button' style={{fontSize: "11px", width: "150px", height: "30px", 
                        borderColor: "#BF5E49", marginLeft: "10px", marginTop: "10px", backgroundColor: "#BF5E49B0",
