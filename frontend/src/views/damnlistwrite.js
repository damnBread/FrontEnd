...
const Damnlistwrite = () => {
  ...
  const [minAge, setMinAge] = useState(initialAgeLimit);
  const [maxAge, setMaxAge] = useState(initialAgeLimit);
  ...
  const handleModalOpen = () => {
    ...
    setGenderLimit(genderLimit);
    setAgeLimit({ min: minAge.min, max: maxAge.max });
    setCareerLimit(careerLimit);
    setModalOpen(true);
  };
      ...
      <div className="header">
        ...
        <div className="damnlistjobbrand">
          <p className="job-title-recommend">
            입력한 제목을 바탕으로 <span>업직종</span>을 추천드립니다
          </p>

          <p className="job-title-recommend2">
            입력한 제목을 바탕으로 <span>브랜드</span>을 추천드립니다
          </p>
        </div>
        <div className="gray-line1"></div>
          ...
          <div className="damnlistworkstart">
            <div className="start-end-time">
              <div className="starttime">
                ...
                <input
                  type="time"
                  value={workStart.toLocaleTimeString([], {
                    hour: "2-digit",
                    minute: "2-digit",
                    hour12: false,
                  })}
              ...
              <div className="endtime">
                ...
                <input
                  type="time"
                  value={workEnd.toLocaleTimeString([], {
                    hour: "2-digit",
                    minute: "2-digit",
                    hour12: false,
                  })}
        ...
        <div className="damnlistage">
          ...
          <p className="damnlist-age-controller">
            ...
            {minAge.min !== null && maxAge.max !== null
              ? `min: ${minAge.min}, max: ${maxAge.max}`
              : ""}
            {careerLimit === -1
              ? "경력무관"
              : careerLimit === 0
        ...
        >
          ...
          <StyledSelect onChange={(e) => setGenderLimit(e.target.value)}>
            <option value={false}>여성우대</option>
            <option value={true}>남성우대</option>
          </StyledSelect>
          <StyledSelect onChange={(e) => setMinAge(e.target.value)}>
            <option value="연령무관">연령무관</option>
            <option value="20">20대</option>
            <option value="30">30대</option>
          </StyledSelect>

          <StyledSelect onChange={(e) => setMaxAge(e.target.value)}>
            <option value="연령무관">연령무관</option>
            <option value="20">20대</option>
            <option value="30">30대</option>
          </StyledSelect>
          <StyledSelect
            onChange={(e) => setCareerLimit(parseInt(e.target.value))}
          >
            <option value="-1">경력무관</option>
            <option value="0">신입</option>
            <option value="0">경력우대</option>
          </StyledSelect>
          <Button
            variant="outlined"
            sx={{
